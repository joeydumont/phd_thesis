...
Historical development of high-power laser chains.
...
\section{Experimental detection of SF-QED observables}
...
\begin{figure}
  ...
  \caption[Map of non-linearity parameters in intensity-frequency space.]
          {Value of the $\xi$ parameter as a function of intensity in \si{\watt\per\cm\square}
...
%{\includegraphics[width=5cm]{name}}
  ...
  {figure}[\FBwidth]
  {\hspace{2cm}\caption[Domain decomposition strategy employed in the StrattoCalculator.]
