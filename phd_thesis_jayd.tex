...
chain. The exact geometry of an off-axis parabolic mirror used in this thesis
is shown in Fig.~\ref{}.
...
is manifest in the angular spectrum angular radiation (Fig.~\ref{}). This could
be advantageous however, as most of the emission is in the sidelobes around
the peak of the reflected laser beam.

On-axis configurations, for their part, deliver a highly symmetric emission
spectrum, but that copropagates with the incident laser beam, complicating
detection.
...
todo[inline]{Perspectives: QED transition amplitudes in plasmas.
