...
Dirac equation. It is very difficult to solve this system self-consistently \cite{https://arxiv.org/abs/1607.04224}.
...
\cite{Salamin2007}
  ...
  \end{aligned}
  \end{equation}
Depending on the choice of boundary condition for these equations, a number
of different field models can be generated.
...
\todo[inline]{Mention difficulty in handling complicated spectral profiles,
necessary in modeling local details of the fields.}
...
Indeed, by reviewing some of the methods based on the Lax series, we will see
that they do not reproduce the large ellipticities that the vectorial theory
predicts, but do predict the proper qualitative feature of the longitudinal
fields.
