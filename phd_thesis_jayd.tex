...
from it. We can write
  \begin{subequations}
  \begin{align}
    \vb{P} &= 2\left[\frac{4\alpha^2}{45}\mathcal{F}\vb{E}+\frac{14\alpha^2}{45}\mathcal{G}\vb{B}\right] \\
    \vb{M} &= -2\left[\frac{4\alpha^2}{45}\mathcal{F}\vb{B}+\frac{14\alpha^2}{45}\mathcal{G{\vb{E}}}]
  \end{align}
  \end{subequations}
