...
\todo[inline]{Add more background on OPA laser systems. Paraxial propagation for most
  ...
  the interaction region. Add figure.}
...
\begin{wrapfigure}{R}{0.3\textwidth}
  \centering
  \includegraphics{light_table/DomainDecomposition/hpc-domaindecomposition.pdf}
  \caption[Domain decomposition strategy employed in the StrattoCalculator.]
          {Parallelization strategy used in the StrattoCalculator. The domain
            over which the integrals are evaluted is distributed among multiple
...
\begin{figure}
  \begin{subfigure}[t]{0.32\textwidth}
    \centering
    \includegraphics[width=\textwidth]{light_table/SCIntegrandOscillation/phase_0L.pdf}
  ...
  \begin{subfigure}[t]{0.32\textwidth}
    \centering
    \includegraphics[width=\textwidth]{light_table/SCIntegrandOscillation/phase_10L.pdf}
  ...
  \begin{subfigure}[t]{0.32\textwidth}
    \centering
    \includegraphics[width=\textwidth]{light_table/SCIntegrandOscillation/phase_100L.pdf}
  ...
  \caption[Illustration of oscillation of the integrand with increasing distance from the focal point.]
          {Integrand of the $E_r$ component of a radially polarized beam with parameters given in
            Table \ref{tab:...}, for the frequency component at $\lambda=800\si{\nano\metre}$.
            ...
            (see \textbf{(b)} and \textbf{(c)}), the strength of the oscillation incrases in
            accordance with Eq.~\eqref{}.
          }
  \label{fig:oscillating-phase-with-distance}
\end{figure}
...
\todo[inline]{Show incident field oscillate differently for different
...
\begin{figure}
  ...
  \begin{subfigure}[t]{0.47\textwidth}
    \includegraphics[width=\textwidth]{light_table/ParallelEfficiency/ParallelEfficiency-mp2.pdf}
  ...
  \hfill
  \begin{subfigure}[t]{0.47\textwidth}
    \includegraphics[width=\textwidth]{light_table/ParallelEfficiency/ParallelEfficiency-gp3.pdf}
...
\todo[inline]{Add figure of HNA vs VSF parabolas.}
...
\todo[inline]{Graph of max E and H intensity as a function of $\alpha$.}
  ...
  \begin{figure}
    \begin{subfigure}{0.47\textwidth}
      \centering
      \includegraphics[width=\textwidth]{bin/Fields/Stratto/na_vsf_lin_g/stra-vsf-lin_00001.BQ/00001.BQ/ElectricIntensityTimeWaterfall-cropped.pdf}
    ...
    \begin{subfigure}{0.47\textwidth}
      \centering
      \includegraphics[width=\textwidth]{bin/Fields/Stratto/na_vsf_lin_g/stra-vsf-lin_00010.BQ/00010.BQ/ElectricIntensityTimeWaterfall-cropped.pdf}
...
\begin{figure}
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=\textwidth]{bin_tmp/RichardsWolf/f0.04375/RichardsWolf_fp.pdf}
  ...
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=\textwidth]{bin_tmp/na_vsf_lin_g/stra-vsf-lin_focal0.04375.BQ/StrattonChu_fp.pdf}
...
to the VSF.LIN.G type, the two formalisms start to diverge (Fig.~\ref{}).
...
the RW formalism underestimates the amount of energy that persist at the
focal spot, even at very small focal lengths.

\begin{figure}
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=\textwidth]{bin_tmp/RichardsWolf/f0.00875/RichardsWolf_fp.pdf}
  ...
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=\textwidth]{bin_tmp/na_vsf_lin_g/stra-vsf-lin_focal0.00875.BQ/StrattonChu_fp.pdf}
...
\caption[Richards-Wolf vs Stratton-Chu: fields in the focal plane, VSF.LIN.G.f0.00875.]
        ...
        the squared magnitude of a single Fourier component of the focused
        electromagnetic field.}
\label{fig:sc.sc-vs-rw-vsf-lin-g-f0.08875}
\end{figure}
...
\begin{table}
  \centering
  \begin{tabular*}{0.5\columnwidth}{@{\extracolsep{\fill} }lS[table-number-alignment = center, table-align-exponent = false]c|lSc}
    \toprule
...
\todo[inline]{From off-axis parabola to on-axis parabola for tighter focal spots.}

\subsection{Varying the Focal Length}

\todo

\todo[inline]{Compare results and prensetation with
