...
where $g$ is the scalar Green's function
  ...
  \end{equation}
The crux of the derivation lies in the formation of the product
  \begin{equation}
...
of the scatterer $S$. Judiciously using vector calculus identities and noting
...
of the incident field on the surface of the mirror. They are valid for arbitrary
...
The next section
will be devoted to the efficient numerical evaluatio of Eqs.~\eqref{eq:sc.stratton-chu-poa-og}
for arbitrary incident fields $\{\vb{E}_\text{inc},\vb{B}_\text{inc}\}$ with
complex time-dependence and for arbitrary mirror geometries $S$.
