...
(Fig.~\ref{fig:intro.intensity-history}). \todo{Add applications of HPL other than
QED stuff. Wakefield acceleration as catalyst of other applications (also QED).
Probably cite JCK's work on phase contrast imaging.}
...
fields, the spatial extension of the field is on the same order as its wavelength,
