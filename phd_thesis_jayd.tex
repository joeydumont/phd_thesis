...
other observables. The former typically outputs large files, up to hundrends
...
for the electric field
  \begin{align}
    ...
    B_z       &= A\int_0^{1}\frac{2\xi\rho^2 E_0(r)}{(\rho^2+\xi^2)^2}\int_0^{2\pi}
        \sin\theta e^{iF(\vb{r},\vb{r}')}d\theta dr,
  \end{align}
  \end{subequations}
